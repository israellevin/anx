...
LOGGER = logging.getLogger('anx.db')
DB_HOST = os.environ.get('ANX_DB_HOST', 'localhost')
DB_USER = os.environ.get('ANX_DB_USER', 'root')
DB_PASS = os.environ.get('ANX_DB_PASS', 'pass')
DB_NAME = os.environ.get('ANX_DB_NAME', 'anx')
